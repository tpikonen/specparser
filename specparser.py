...
# Public methods
    ...
    def header(self):
        """Returns the spec-file header (possibly incomplete) in a dictionary"""
    ...
    def next_scan_header(self):
        """Return a dictionary with the header of the next scan,
        or InputTimeout"""
    ...
    def next_scan(self):
        """Returns the next scan in the file (with all the points),
